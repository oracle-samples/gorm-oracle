...
func TestJoinArgsWithDB(t *testing.T) {
	...
	tests.AssertEqual(t, user1.NamedPet.Name, "joins-args-db_pet_2")
	...
	tests.AssertEqual(t, user2.NamedPet.Name, "")
	...
	tests.AssertEqual(t, user3.NamedPet.Name, "joins-args-db_pet_2")
	...
	tests.AssertEqual(t, user4.NamedPet.Name, "")
}
...
func TestJoinsPreload_Issue7013_RelationEmpty(t *testing.T) {
	...
	tests.AssertEqual(t, entries, []Building{{Model: home.Model, Name: "relation_empty", Owner: Owner{Company: Company{}}}})
}
